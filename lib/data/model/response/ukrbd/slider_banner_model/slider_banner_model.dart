...
SliderBannerModel sliderBannerModelFromJson(String str) => SliderBannerModel.fromJson(json.decode(str));
String sliderBannerModelToJson(SliderBannerModel data) => json.encode(data.toJson());
class SliderBannerModel {
  ...
  SliderBannerModel.fromJson(dynamic json) {
