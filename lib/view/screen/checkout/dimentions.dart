...
class AppDimension {
  ...
  static double left({@required double figPadding,@required BuildContext context}){
    final size=MediaQuery.of(context).size;
    final aspectRatio=figPadding/FIGMA_SCREEN_SIZE;
  ...
  static double right({@required double figPadding,@required BuildContext context}){
    final size=MediaQuery.of(context).size;
    final aspectRatio=figPadding/FIGMA_SCREEN_SIZE;
  ...
  static double bottom({@required double figPadding,@required BuildContext context}){
    final size=MediaQuery.of(context).size;
    final aspectRatio=figPadding/FIGMA_SCREEN_SIZE;
  ...
  static double top({@required double figPadding,@required BuildContext context}){
    final size=MediaQuery.of(context).size;
    final aspectRatio=figPadding/FIGMA_SCREEN_SIZE;
