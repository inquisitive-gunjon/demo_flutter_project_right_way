...
//     this.extraDiscount,
//     this.extraDiscountType, this.isNotification = false});
//
//   @override
...
//
//
//                   print('only digital product is ordered======>${order.onlyDigital}');
//
...
//                                 Expanded(child: Padding(
//                                   padding: const EdgeInsets.symmetric(vertical: 1),
//                                   child: Text(' ${widget.orderModel.billingAddressData != null ? widget.orderModel.billingAddressData.address : ''}',
...
//                                       orderType: widget.orderType, paymentStatus: order.trackingModel.paymentStatus),
//                                   ),
//                                 ]),
//                           );
//                         },
...
//                         child: Row(children: [Expanded(child: widget.orderModel != null &&
//                             widget.orderModel.orderStatus =='pending' && widget.orderType != "POS"?
//
